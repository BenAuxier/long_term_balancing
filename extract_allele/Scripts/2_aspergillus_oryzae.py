...
filtered_candidate_data, candidate_merge = process_results(CDS_dict,candidate_data,lower_limit, upper_limit,annotation_sorted_dict, transfer_id, minimal_length)

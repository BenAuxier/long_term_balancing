...
def prepare_statistic_data(base_depth, statistics_path, filtered_region_depth, gene_region_depth,
    ...
    whitespace_txt_to_csv(filtered_region_depth, gene_depth_file, num_lines)

    # 3. copy the depth of each gene
    all_depth_file = f"{statistics_path}/all_gene_depth.csv"
    whitespace_txt_to_csv(gene_region_depth, all_depth_file, num_lines)
...
if __name__ == "__main__":
    ...
    filtered_region_depth = f"{main_path}/depth_calculation/mean_depth_region.txt"
    gene_region_depth = f"{main_path}/depth_calculation/mean_depth_gene.txt"
    ...
    prepare_statistic_data(base_depth, statistics_path, filtered_region_depth, gene_region_depth, summary_out_file, region_output_file, assembly_list, refseq_candidate_file)

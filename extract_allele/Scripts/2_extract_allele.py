...
#depth_path = "/lustre/BIF/nobackup/leng010/test/aspergillus_fumigatus/depth_calculation/mean_depth.txt"
...
print("annotation_sorted, annotation_sorted_dict finished")
...
print("candidate_merge finished")
# test the main code
...
print("candidate_data_summary finished")
# extract sequences
...
print("results_path,sequence_path finished")
#run clinker
clinker_html, clinker_data = run_clinker_batch(sequence_path, results_path)

print("clinker finished")